...
export default function SvgTest() {
  const userSvg = `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
`;
  const User = () => <SvgXml xml={userSvg} width="60" height="60"></SvgXml>;
  return <User />;
}
